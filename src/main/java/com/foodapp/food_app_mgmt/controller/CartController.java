...
//    @PostMapping("/addToCart/{item_id}/{qty_id}/{user_id}")
//    public String addToCart(@PathVariable Long item_id, @PathVariable Long qty_id,@PathVariable User user_id){
//        System.out.println("add to cart");
////        User user = new User();
//        //to save to cartItem table.
//        dataService.addToCart(item_id,user_id,qty_id);
...
//    }
    ...
    @GetMapping("/cart/{id}")
    public ResponseEntity<List<CartItem>> getCartById(@PathVariable Long id) {
